...
public class GesturesPressAndLongPress {
    public static void main(String[] args) throws Exception {
        ...
        //t.press(ElementOption.element(driver.findElement(accessibility))).perform();
        //t.press(ElementOption.element(driver.findElement(accessibility))).release().perform();
...
//                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(5000))).release().perform();
        //t.longPress(ElementOption.element(driver.findElement(accessibility))).release().perform();
